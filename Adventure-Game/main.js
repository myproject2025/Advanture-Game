...
console.log(gradientText.multiline("\n*************WELCOME TO MY ADVENTURE GAME*************\n"));
...
console.log(`\n${gradientText("********************")}${chalk.italic.underline.red.bold(player.name)} ${gradientText("V/S")} ${chalk.green.bold.italic.underline(opponent.select)}${gradientText("********************")}\n`);
// GATE DATA
